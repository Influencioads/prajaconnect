  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Ground Intel', description: 'Opposition feed, field log & visit staleness', href: '/ground-intel' as Href, module: ModuleKey.GroundIntel, icon: 'map', tint: colors.danger },
        { label: 'Scorecards', description: 'Mandal ranking & cadre leaderboard', href: '/scorecards' as Href, module: ModuleKey.Scorecards, icon: 'trophy', tint: colors.success },
      ],
    },
    {
      title: 'Service desk',
